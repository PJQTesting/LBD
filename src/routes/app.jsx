...
import ReactPractice from 'views/ReactPractice/ReactPractice';
...
const appRoutes = [
    ...
    { path: "/aws", name: "AWS", icon: "pe-7s-cloud-download", component: AWS },
    { path: "/reactPractice", name: "React", icon: "pe-7s-light", component: ReactPractice },
